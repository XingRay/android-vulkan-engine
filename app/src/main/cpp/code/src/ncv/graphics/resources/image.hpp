...
namespace graphics {
    namespace resources {
        ...
        public:
            ...
            image_base(const vk::PhysicalDevice &a_gpu, vk::Device a_device)
                    : base{a_gpu, a_device} {}
        ...
        public:
            image(const vk::PhysicalDevice &a_gpu, vk::Device a_device, AHardwareBuffer *a_buffer);
        ...
        public:
            image(const vk::PhysicalDevice &a_gpu, vk::Device a_device,
        ...
        image<device_upload, ImageDataFormat>::image(const vk::PhysicalDevice &a_gpu,
                                                     vk::Device a_device, vk::ImageUsageFlags a_usage, vk::SharingMode a_sharing,
