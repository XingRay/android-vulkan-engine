...
//        m_device.bindImageMemory2KHR(bind_info);
        engine::vkBindImageMemory2KHR(m_device, 1, reinterpret_cast<VkBindImageMemoryInfo*>(&bind_info));
...
//        m_device.getImageMemoryRequirements2KHR(&mem_reqs_info, &mem_reqs2);
        engine::vkGetImageMemoryRequirements2KHR(m_device, reinterpret_cast<VkImageMemoryRequirementsInfo2*>(&mem_reqs_info), reinterpret_cast<VkMemoryRequirements2*>(&mem_reqs2));
