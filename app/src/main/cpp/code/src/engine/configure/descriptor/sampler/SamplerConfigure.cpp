...
#include "engine/configure/descriptor/DescriptorSlotConfigure.h"

#include "engine/vulkan_wrapper/image/VulkanImageBuilder.h"
#include "engine/vulkan_wrapper/sampler/builder/DefaultSamplerBuilder.h"
...
namespace engine {
    ...
    SamplerConfigure &SamplerConfigure::setImage(std::unique_ptr<engine::ImageInterface> &&image) {
