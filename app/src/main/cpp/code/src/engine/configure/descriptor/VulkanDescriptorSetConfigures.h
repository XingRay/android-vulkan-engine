...
namespace engine {
    ...
    public:
        ...
        [[nodiscard]]
        std::unique_ptr<VulkanBufferDescriptorBindingSets> createVulkanBufferDescriptorBindingSets(const VulkanDevice &vulkanDevice, const VulkanCommandPool &commandPool) const;
    };
